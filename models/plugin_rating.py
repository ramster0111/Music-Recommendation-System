...
def plugin_rating(tablename, record_id=0):
	rating = 0
	return TAG[''](DIV(_id='star1',_class='rating'),
                   SCRIPT("jQuery(document).ready(function(){jQuery('#star1').rating('%s',{maxvalue:5,curvalue:%s});});" % (URL(r=request,c='plugin_rating',f='rate1',args=[tablename,record_id]),rating)))
